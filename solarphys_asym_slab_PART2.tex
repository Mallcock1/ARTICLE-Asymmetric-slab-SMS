...
\begin{table}
\caption{ A brilliant table caption.}
\label{table label}
\begin{tabular}{|cc|cccc|} % define the column alignment
                                  % l: left, c: center, r: right
                                  % @{.} replace the inter-column by a .
  \hline
Type & Mode & \multicolumn{4}{c}{Squared Alfv\'{e}n/phase speed ratio, $kv_A / \omega$, approximation from amplitude ratio, $R_A$} \\
	 &	    & Thin slab & Wide Slab & Incompressible & Low-beta \\
  \hline
\multirow{2}{4em}{Surface} & Quasi-sausage & $ 1 + \frac{1}{x_0}\left(\frac{R_A\frac{\rho_2}{\rho_0m_2} + \frac{\rho_1}{\rho_0m_1}}{R_A + 1}\right) $  & N/A  & $ 1 + \left( \frac{R_A \frac{\rho_2}{\rho_0} + \frac{\rho_1}{\rho_0}}{R_A + 1} \right) \coth{kx_0} $ & $ 1 + k \left( \frac{ \frac{\rho_1}{\rho_0m_1} + R_A\frac{\rho_2}{\rho_0m_2}}{1 + R_A} \right) \coth{kx_0} $ \\
						   & Quasi-kink	   & $ 1 + k^2x_0\left(\frac{R_A\frac{\rho_2}{\rho_0m_2} - \frac{\rho_1}{\rho_0m_1}}{R_A - 1}\right) $ & N/A  & $ 1 + \left( \frac{R_A \frac{\rho_2}{\rho_0} - \frac{\rho_1}{\rho_0}}{R_A - 1} \right) \tanh{kx_0} $ & $ 1 + k \left( \frac{ \frac{\rho_1}{\rho_0m_1} - R_A\frac{\rho_2}{\rho_0m_2}}{1 - R_A} \right) \tanh{kx_0} $ \\
\multirow{2}{4em}{Body}    & Quasi-sausage & N/A & N/A & N/A & N/A \\
						   & Quasi-kink	   & N/A & N/A & N/A & N/A \\
  \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|cc|cccc|} % define the column alignment
                                  ...
                                  % @{.} replace the inter-column by a .
  \hline
Type & Mode & \multicolumn{4}{c}{Squared Alfv\'{e}n/phase speed ratio, $kv_A / \omega$, approximation from minimum perturbation shift, $\Delta_{min}$} \\
	 &	    & Thin slab & Wide Slab & Incompressible & Low-beta \\
  \hline
\multirow{2}{4em}{Surface} & Quasi-sausage & $ \frac{\rho_1}{\rho_0m_1}(x_0 + \Delta_{min}) + \frac{1}{1 + (\omega / kc_0)^2} $ & N/A & $ 1 + \frac{\rho_1}{\rho_0}\tanh{k(x_0 + \Delta_{min})} $ & $ 1 + \frac{k\rho_1}{m_1\rho_0}\tanh{k(x_0 + \Delta_{min})} $ \\
						   & Quasi-kink	   & N/A & Yet to derive & $ 1 + \frac{\rho_1}{\rho_0}\coth{k(x_0 + \Delta_{min})} $ & $ 1 + \frac{k\rho_1}{m_1\rho_0}\coth{k(x_0 + \Delta_{min})} $ \\
\multirow{2}{4em}{Body}    & Quasi-sausage & N/A & N/A & N/A & N/A \\
						   & Quasi-kink	   & N/A & N/A & N/A & N/A \\
  \hline
\end{tabular}
