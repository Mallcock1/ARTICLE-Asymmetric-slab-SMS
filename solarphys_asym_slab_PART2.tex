...
\begin{figure}
\centering
\subfloat[]{\includegraphics[scale=0.35]{media/slow-kink-surf_amp-ratio.png}
\label{fig: AR slow kink surf}}
\subfloat[]{\includegraphics[scale=0.35]{media/slow-kink-surf_min-pert-shift.png}
\label{fig: MPS slow kink surf}} \\
\subfloat[]{\includegraphics[scale=0.35]{media/slow-saus-surf_amp-ratio.png}
\label{fig: AR slow saus surf}}
\subfloat[]{\includegraphics[scale=0.35]{media/slow-saus-surf_min-pert-shift.png}
