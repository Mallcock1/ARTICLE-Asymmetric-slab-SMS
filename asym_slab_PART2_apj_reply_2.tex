...
In the present work, we derive two novel analytical tools for spatial seismology that use an asymmetric slab waveguide to approximate background parameters. This has applications to solar atmospheric structures that are locally slab-like which have been observed to guide MHD oscillations, such as elongated magnetic bright points \citep{yua_etal14}, prominences \citep{arr_etal12}, and light walls, which are structures consisting of surges, brightenings, and other magnetic structures rooted in sunspot light bridges \citep{roy73,shi_etal09,yan_etal15,hou_etal17,yan_etal17,zha_etal17}.
